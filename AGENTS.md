...
FastAPI demo app for Deepgram Transcription.
...
```
feat(fastapi-transcription): add diarization support
fix(fastapi-transcription): resolve WebSocket close handling
refactor(fastapi-transcription): simplify session endpoint
